    ...
    public class AutoMapperProfiles:Profile
    {
        public AutoMapperProfiles(NetTopologySuite.Geometries.GeometryFactory geometryFactory)
        {
            ...
            CreateMap<MovieTheaterCreationDTO, MovieTheater>()
                 ...
                 geometryFactory.CreatePoint(new NetTopologySuite.Geometries.Coordinate(dto.Longitude, dto.Latitude))));
            ...
            CreateMap<Movie, MovieDTO>()
                ...
                .ForMember(x => x.MovieTheaters, options => options.MapFrom(MapMovieTheatersMovie))
        ...
        private List<MovieTheaterDTO> MapMovieTheatersMovie(Movie movie, MovieDTO movieDTO )
        {
